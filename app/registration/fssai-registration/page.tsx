...
const eligibilityCriteria = [
    {
        ...
        description: "Applicable to petty retailers dealing in food products or any person manufacturing and selling food articles independently."
    },
    {
        title: "Temporary Food Stalls or Small-Scale Operations",
        description: "Individuals who sell food products through temporary stalls or distribute food during religious and social gatherings (excluding caterers)."
    },
    {
        title: "Small-Scale or Cottage Food Industries",
        description: "Businesses working at a minimal scale, including industries with limited production capacities in food, milk, or meat."
    }
];
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">FSSAI Registration in India</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Key Features of FSSAI Registration</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Issuance of FSSAI Registration</h2>
                <p className="text-muted-foreground text-justify">
                  FSSAI stands for the Food Safety and Standards Authority of India, an autonomous organisation under the Ministry of Health and Family Welfare, Government of India. Established under the Food Safety and Standards Act, 2006 (FSS Act), FSSAI governs the food business in India, ensuring that food products meet quality standards and undergo safety checks. Its primary goal is to eliminate food adulteration and the sale of substandard products while maintaining the safety of food products across the country.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Food Business Operators Who Require FSSAI Registration</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Types of FSSAI Registration</h2>
                <p className="text-muted-foreground text-justify mb-4">
                  FSSAI registrations are categorized based on a food business’s turnover, production capacity, and other operational details. Businesses must choose from three main types of registrations/licenses—Basic, State, or Central—depending on their turnover and production scope. Below is an overview of each registration type and the corresponding eligibility criteria:
                </p>
                <div className="space-y-4">
                    <div>
                        <h3 className="font-semibold text-lg">FSSAI Basic Registration</h3>
                        <ul className="space-y-1 pl-5 list-disc text-muted-foreground">
                            <li><strong>Who Needs It:</strong> Food Business Operators (FBOs) with an annual turnover of less than INR 12 lakh.</li>
                            <li><strong>Registration Form:</strong> Form A</li>
                            <li><strong>Key Point:</strong> This registration is generally for small-scale or startup food ventures, such as small retailers or home-based food producers.</li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg">FSSAI State License</h3>
                        <ul className="space-y-1 pl-5 list-disc text-muted-foreground">
                            <li><strong>Who Needs It:</strong> FBOs with an annual turnover between INR 12 lakh and INR 20 crore.</li>
                            <li><strong>Registration Form:</strong> Form B</li>
                            <li><strong>Key Point:</strong> Medium-sized ventures—like mid-level restaurants, small to mid-scale manufacturers, and distributors—typically require the State License.</li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="font-semibold text-lg">FSSAI Central License</h3>
                        <ul className="space-y-1 pl-5 list-disc text-muted-foreground">
                            <li><strong>Who Needs It:</strong> FBOs with an annual turnover exceeding INR 20 crore.</li>
                            <li><strong>Registration Form:</strong> Form B</li>
                            <li><strong>Key Point:</strong> Large-scale food businesses—such as major manufacturers, major retailers, and large distributors—must apply for the Central License.</li>
                        </ul>
                    </div>
                </div>
                 <p className="text-muted-foreground text-justify mt-4">
                    By choosing the registration/license that aligns with their business size and turnover, FBOs ensure they comply with the regulations laid down by the Food Safety & Standards Authority of India (FSSAI).
                </p>
              </div>
              
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">FSSAI Registration Eligibility</h2>
                <p className="text-muted-foreground text-justify mb-4">
                  FSSAI Registration serves as a basic license for Food Business Operators (FBOs) who run small-scale food operations. The following categories of businesses must obtain FSSAI Registration:
                </p>
                ...
                <div className='mt-4'>
                 ...
                 <p className="text-muted-foreground text-justify mt-4">
                    All the above categories must meet FSSAI’s basic registration requirements to operate legally under the Food Safety & Standards (Licensing and Registration of Food Business) Regulations, 2011.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Procedure for Obtaining FSSAI Registration Online</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Documents Required for FSSAI Registration</h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Recent Amendments in FSSAI Regulations (2025)</h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Benefits of FSSAI Registration</h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Why Choose CACSFinacc for Your FSSAI Registration?</h2>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
