        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-8">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">What is LEI Registration?</h2>
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Structure of an LEI Code</h2>
                            ...
                            <TableBody>
                                <TableRow>
                                    {structure.map((item, index) => (
                                        <TableCell key={index} className={item.class}>{item.char}</TableCell>
                                    ))}
                                </TableRow>
                                <TableRow>
                                    {structureDesc.map((item, index) => (
                                        <TableCell key={index} colSpan={item.colspan} className={item.class}>{item.desc}</TableCell>
                                    ))}
                                </TableRow>
                            </TableBody>
                        </Table>
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Purpose of LEI Registration Code</h2>
                     <p className="text-muted-foreground text-justify">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Applicability of LEI Register Code</h2>
                    <p className="text-muted-foreground text-justify mb-4">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Who Needs an LEI in India?</h2>
                    <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                     ...
                     <p className="text-muted-foreground text-justify mt-4 text-sm">
                        <strong>Note:</strong> Entities with exposure above ₹5 crore and up to ₹10 crore need to obtain an LEI by April 30, 2025.
                    </p>
                </div>

                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Documents Required for LEI Registration</h2>
                    <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">LEI Registration Process</h2>
                    ...
                    <p className="text-muted-foreground text-justify mt-4 text-sm">
                        <strong>Note:</strong> The LEI is valid for one year and must be renewed annually.
                    </p>
                </div>

                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">LEI Renewal Process</h2>
                     <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Benefits of Obtaining an LEI</h2>
                     <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
                ...
                <div>
                    <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Why Choose CACSFinacc for Your LEI Registration?</h2>
                     <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
