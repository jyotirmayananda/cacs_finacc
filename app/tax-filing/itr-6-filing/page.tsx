...
const keyAmendments = [
    ...
    },
    {
        ...
        description: "A new dropdown-style selection has been introduced to specify the due date of return filing, with options including: July 31, October 31, November 30. Taxpayers must also indicate the section under which the return is being filed, such as:",
        items: [
    ...
    },
    {
        ...
        description: "Companies must now disclose profits/losses from cryptocurrencies or digital assets."
    },
    {
        title: "Enhanced Reporting under Schedule BP",
        description: "Breakup of income from business/profession, capital assets, dividend, and others required."
    },
    {
        title: "Depreciation Schedule Overhaul",
        description: "Asset-wise disclosure for depreciation under the Income Tax Act is now compulsory."
    },
    {
        title: "Updated Schedule FA (Foreign Assets)",
        description: "Companies holding shares, interests, or bank accounts abroad must file detailed information."
    },
    {
        title: "Audit Trail Compliance",
        description: "As per MCA notification, companies must confirm whether accounting software has audit trail capabilities from 01.04.2024 onwards."
    }
];
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                <p className="text-muted-foreground text-justify">
                  The Central Board of Direct Taxes (CBDT) has notified the updated Income
                  Tax Return (ITR) Form 6 for the Assessment Year (AY) 2025–26, effective from April
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  CACSFinacc offers expert ITR-6 filing services to ensure accurate and timely
                  submission of your company's income tax return. We handle the complexities of ITR-6
                  filing, allowing you to focus on your core business activities.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">What is ITR-6?</h2>
                <p className="text-muted-foreground text-justify mb-4">
                  ITR-6 is the Income Tax Return form applicable to companies registered under the
                  Companies Act, except those claiming exemption under Section 11. It is mandatory to
                  file ITR-6 online with a digital signature.
                </p>
                <p className="text-muted-foreground text-justify mb-2">This form is mainly used by:</p>
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Companies claiming exemption under Section 11 (i.e., charitable or religious
                  trusts) should use ITR-7.
                </p>
              </div>
              
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Who Must File ITR-6?</h2>
                <p className="text-muted-foreground text-justify mb-4">
                ...
                <p className="text-muted-foreground text-justify mt-4">
                  Companies with income from dividends, foreign subsidiaries, royalties, interest,
                  capital investments, and domestic/foreign transactions must use this form.
                </p>
                <p className="text-muted-foreground text-justify mt-4 text-sm">
                  <strong>Note:</strong> Companies claiming exemption under Section 11 (charitable or
                  religious trusts) are not eligible to use ITR-6.
                </p>
              </div>
              
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Key Amendments & Updates for AY 2025-26</h2>
                <ol className="space-y-4 list-decimal pl-5">
                  {keyAmendments.map((amendment, index) => (
                    <li key={index}>
                      <p className="font-semibold">{amendment.title}</p>
                      {amendment.description && <p className="text-muted-foreground mt-1">{amendment.description}</p>}
                      {amendment.items && (
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Guidelines & Compliance for Companies</h2>
                <p className="text-muted-foreground text-justify mb-4">
                  The Institute of Chartered Accountants of India (ICAI) mandates strict adherence to:
                </p>
                <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Key Disclosures in ITR-6</h2>
                 <ul className="space-y-3 pl-5 list-disc text-muted-foreground">
              ...
              <div>
                <h2 className="text-2xl font-bold font-headline mb-4 text-primary">Step-by-Step ITR-6 Filing Process at CACSFinacc</h2>
