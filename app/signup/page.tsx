...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px" {...props}>
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.99,34.551,44,29.825,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
    </svg>
)
 ...
 return (
    <div className="min-h-screen w-full bg-background lg:grid lg:grid-cols-2">
      <div className="relative hidden lg:flex flex-col items-center justify-center bg-blue-900 text-white p-12 text-center">
         <Image
            src="https://picsum.photos/seed/auth-bg2/1000/1200"
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-bold font-headline mb-4">Join Us Today</h2>
          <p className="text-blue-200 max-w-sm mx-auto">
            Create an account to manage your financial services, track compliance, and get expert advice.
          </p>
        </div>
      </div>
